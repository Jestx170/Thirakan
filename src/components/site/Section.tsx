...
export function Eyebrow({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--brand-accent)]">
      <span className="h-px w-6 bg-[color:var(--brand-accent)]" />
      {children}
    </span>
  );
}

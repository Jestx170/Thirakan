...
const SERVICES = [
  {
    icon: Watch,
    title: "บริการซ่อมนาฬิกาโดยผู้เชี่ยวชาญ",
    desc: "ให้บริการตรวจวิเคราะห์ ซ่อม และบำรุงรักษานาฬิกาทุกประเภท ด้วยเครื่องมือมาตรฐานและประสบการณ์ของทีมช่าง",
  },
  {
    icon: Wrench,
  ...
  {
    icon: History,
    title: "บูรณะและฟื้นฟูนาฬิกา",
    desc: "ให้บริการฟื้นฟู เพื่อให้นาฬิกากลับมาทำงานได้อย่างเต็มประสิทธิภาพ พร้อมคงคุณค่าและอายุการใช้งานในระยะยาว",
  },
];
    ...
    <Section tone="default">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <SectionHeading
          ...
          title={
            <>
              ใส่ใจทุกขั้นตอนการซ่อม  <br className="hidden lg:block" />
              เพื่อให้นาฬิกาของคุณกลับมาทำงานได้อย่างเต็มประสิทธิภาพ
            </>
          }
          description={
            compact
              ? "ไม่ว่าจะเป็นการเปลี่ยนถ่าน ซ่อมเครื่อง ขัดตัวเรือน หรือบูรณะนาฬิกาวินเทจ ทุกงานดำเนินการภายในเวิร์กช็อปของเราโดยทีมช่างผู้เชี่ยวชาญ"
